bfCheckJavaPath;
metadata = bfGetReader('Z:\Dataset1-LSP13626-melanoma_in-situ.tif');
...
MHCI_resize = imresize3(MHCI,[2754 5454 194],'nearest');
...
metadata = bfGetReader('Z:\segmentation\F8lla_MIS_mask.tif');
...
writetable(stats,'Z:\F8ll_results\distance_transform.csv');